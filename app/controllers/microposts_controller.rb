class MicropostsController < ApplicationController
  ...
  def create
    ...
    if @micropost.save
      ...
      @feed_items = current_user.feed_items.includes(:user).order(created_at: :desc).page(params[:page]) #MicropostsControllerのcreateメソッドでもエラーが発生した場合はstatic_pages/homeテンプレートを使用
